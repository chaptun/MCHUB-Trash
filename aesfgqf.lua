...
function CheckQuest()
	...
	if NewWorld then
		...
		elseif MyLevel == 1000 or MyLevel <= 1049 then -- Snow Trooper [Lv. 1000] **
			...
			CFrameMon = CFrame.new(562.0009765625, 401.4220275878906, -5372.97021484375)
...
coroutine.wrap(function()
	pcall(function()
		game:GetService("RunService").Heartbeat:Connect(function()
			if _G.AutoFarm or _G.AutoBuddy or _G.AutoCavender or _G.Canvender or _G.Buddy or _G.Yamma or AutoShrakman or Auto_Bone or _G.FARMPLAYERS or _G.autoraid or getgenv().AutoNew or statetp1 or Autothird or _G.AutoTEST or _G.AutoFarmMBF or _G.AutoFarmGun or _G.KenHaki then
...
spawn(function()
	while game:GetService("RunService").Stepped:wait(10) do
		...
		if _G.NoClip or _G.AutoBuddy or _G.AutoCavender or _G.Canvender or _G.Buddy or Auto_Bone or _G.Yamma or _G.AutoFarm or KillPlayer or getgenv().AutoNew or Autothird or Autothird or Factory or NextIsland or TweenIsland or _G.AutoTEST or _G.AutoFarmMBF or _G.AutoFarmGun then
			pcall(function()
...
spawn(function()
	while task.wait(0.000000000000000000000000001) do
		pcall(function()
			CheckQuest()
			for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
				if _G.AutoFarm or _G.Superhuman or AutoShrakman and StartMagnet then
					if game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool") then
						if v.Name == Ms then
							...
							elseif v.Name == Ms and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
