local Library = {Toggle = false,FirstTab = true,TabCount = 0,ColorTable = {}}
...
function Library:CreateWindow(Config, Parent)
	...
	Screen.Name =  Config.WindowName--HttpService:GenerateGUID(false)
	...
	local function ChangeColor(Color)
		...
		for i, v in pairs(Library.ColorTable) do
			if v.BackgroundColor3 ~= Color3.fromRGB(50,50,50) then --50,50,50
